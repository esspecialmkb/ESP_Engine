 ...
 * @author Rickard
 */
public class GameFPSCharacterControl extends BetterCharacterControl implements ActionListener, AnalogListener{
    ...
    public GameFPSCharacterControl(float radius, float height, float mass) {
